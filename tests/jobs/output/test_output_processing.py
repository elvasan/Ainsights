...
from jobs.output.output_processing import get_classifications_as_dictionary, transform_output_scoring_columns, \
...
def test_transform_output_scoring_columns(spark_session):
    ...
    result_df = transform_output_scoring_columns(class_df, input_df)
